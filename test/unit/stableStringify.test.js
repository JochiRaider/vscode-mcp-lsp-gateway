...
describe('stableJsonStringify', () => {
    it('produces stable output regardless of key insertion order', () => {
        const a = { b: 1, a: 2 };
        const b = { a: 2, b: 1 };
        (0, chai_1.expect)((0, stableStringify_1.stableJsonStringify)(a)).to.equal((0, stableStringify_1.stableJsonStringify)(b));
    ...
    it('stabilizes nested objects while preserving array order', () => {
        ...
        (0, chai_1.expect)((0, stableStringify_1.stableJsonStringify)(a)).to.equal((0, stableStringify_1.stableJsonStringify)(b));
        (0, chai_1.expect)((0, stableStringify_1.stableJsonStringify)(a)).to.equal('{"a":{"c":3,"d":4},"z":[{"a":2,"b":1}]}');
    });
});
